...
export const NavBody = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full rounded-2xl max-w-full flex-row items-center justify-between self-start px-4 py-2 lg:flex ",
        visible && "rounded-4xl ",
        className
      )}>
      {children}
...
export const NavItems = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "hidden flex-1 flex-row items-center justify-center space-x-2 text-sm font-medium text-white transition duration-100 lg:flex lg:space-x-2",
        className
      )}>
      {items.map((item, idx) => {
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className={cn(
            "absolute inset-x-0 top-10 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-lg bg-white px-4 py-8 shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] ",
            className
          )}>
          {children}
        </motion.div>
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    gradient:
      "bg-primary text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]",
  };
